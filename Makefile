...
UNREALROOTPATH = /home/ronnie/Dev/Unreal-5.2.1/UnrealEngine
GAMEPROJECTFILE =/home/ronnie/Dev/Aura2/Aura/Aura.uproject
...
TARGETS = \
	...
	Aura-Linux-Shipping  \
	Aura \
	AuraEditor-Linux-Debug  \
	AuraEditor-Linux-DebugGame  \
	AuraEditor-Linux-Test  \
...
Aura-Linux-Debug:
	 $(PROJECTBUILD) Aura Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

Aura-Linux-DebugGame:
	 $(PROJECTBUILD) Aura Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

Aura-Linux-Test:
	 $(PROJECTBUILD) Aura Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
AuraEditor-Linux-Debug:
	 $(PROJECTBUILD) AuraEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

AuraEditor-Linux-DebugGame:
	 $(PROJECTBUILD) AuraEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

AuraEditor-Linux-Test:
	 $(PROJECTBUILD) AuraEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
